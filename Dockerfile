...
RUN su meow -c " cd /home/meow && \
  ...
  chmod a+rwx stage && \
  cd /home/meow/weakpwh && ls -l && chmod a+rwx * && ls -l sweep && g++ -g clipper.cpp sweep/advancing_front.cc sweep/cdt.cc sweep/sweep.cc sweep/sweep_context.cc common/shapes.cc weakpwh.cpp -o weakpwh && \
